...
@section('content')
<div class="p-6">
    <h1 class="text-3xl font-bold mb-6 text-white">Tambah Aturan Pelanggaran Baru</h1>
    ...
    <div class="bg-gray-800 rounded-xl shadow-lg p-8 max-w-xl">
        <form action="{{ route('admin.rules.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                <label for="name" class="block text-sm font-medium text-gray-300 mb-2">Nama Aturan (Contoh: Tidak Mengerjakan PR)</label>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" name="points" id="points" value="{{ old('points') }}" required min="1"
                           class="w-full p-3 bg-gray-700 border border-gray-600 rounded-lg focus:ring-red-500 focus:border-red-500 text-sm text-white">
